...
import os
import sys
sys.path.insert(0, "/home/jun/work/AccumulativeAttack")  # 명시적으로 최우선 경로에 추가
...
def ewc_cifar10_resnet_epoch(override_args=None):
    args = create_default_args({
        'cuda': 0, 'ewc_lambda': 1, 'epochs': 50, 'ewc_mode': 'separate', 
        'ewc_decay': None, 'learning_rate': 0.001, 'train_mb_size': 256,
        'seed': 0, 'save_freq': 10
    }, override_args)
    ...
    checkpoint_dir = "checkpoints_cifar10_resnet"
