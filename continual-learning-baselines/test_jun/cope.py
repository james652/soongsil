...
def cope_smnist(override_args=None):
    ...
    # 모델을 pkl 파일로 저장 (모델의 state_dict만 저장)
    model_save_path = "/home/jun/work/continual-learning-baselines/test_jun/trained_model.pkl"
    
    # 모델을 pickle로 저장 (state_dict 저장)
    with open(model_save_path, 'wb') as f:
        pickle.dump({'model_type': 'mlp', 'model': model.state_dict()}, f)
